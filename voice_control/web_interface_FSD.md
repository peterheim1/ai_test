...
### 4.1 WebServer (`voice_control/web_server.py`)
...
Add to `voice_control/config/voice_config.yaml`:
...
1. Create `voice_control/web_server.py` — FastAPI + WebSocket + TTS mute flag
